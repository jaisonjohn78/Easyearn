                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="lecture">
                                ...
                                <?php
                                        $lecture_query =$con->query("select * from videos WHERE category='Elite Package'");
                                ...
                                ?>
                                <a
                                    href="elite-learning-courses.php?lectureId=<?php echo $lecture_id?>&course=<?php echo $lecture_course ?>">
                                    <span class="lecture-name">1 <?php echo $lecture_id ?> . <?php echo $lecture_title ?></span></a><a href="elite-learning-courses.php?lectureId=14&course=1679091c5a880faf6fb5e6087eb1b2dc">
                                    <?php 
                                }
                            }
                                else
