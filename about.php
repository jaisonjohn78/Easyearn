               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="student-wrapper">
                     ...
                     <div class="sitdent-choose-content">
                         <h4>Easyearn is an  ed-Tech  platform.</h4>
                        <p> Its started on 17th october 2021
                            Since then we are inspiring youngsters or those people who willing to learn the valuable and modish courses. 
                        <br>
                        <br>
                        We are trying to bring learning to people instead of people to learning. 
Hence, we are trying to modify their entrepreneurship nature.
<br>
<br>
Here we are with a lot of courses designed in a way that will help people to learn a lot of things and take things to a new level.
                        </p>
                     </div>
               ...
               <div class="col-12">
                  <div class="section-title text-center mb-60">
                     <h2>What People Say <br>
                        <span class="down-mark-line-2"> About US</span></h2>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-xl-6 col-lg-6 col-md-12 mb-30">
                  <div class="browser-course-wrapper course-height" data-background="" style="background-image: url(&quot;&quot;);">
                     ...
                     <div class="row">
                        <div class="col-xl-7 col-lg-7">
                           <div class="browser-course-content">
                              ...
                              <div class="browser-btn">
                                 <a class="course-btn" href="become-affiliate.php">Browse courses</a>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="footer-widget f-w1 mb-40">
                        <div class="footer-img">
                           <a href="index.html"> <img src="assets/images/logo.png" alt="footer-logo" width = "100"></a>
